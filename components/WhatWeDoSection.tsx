...
export default function WhatWeDoSection() {
  return (
    <section className='w-full min-h-screen bg-gradient-to-b from-[#F6FBFB] via-[#E4E8E8] to-[#DEEDED] px-4 sm:px-6 lg:px-8'>
      <div className='max-w-7xl mx-auto pt-12 md:pt-16 pb-12 md:pb-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12'>
            <div className='flex items-start space-x-4 sm:space-x-6'>
              <div className='flex-shrink-0'>
                <div className='w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-teal-400 to-teal-600 rounded-xl flex items-center justify-center shadow-lg'>
        ...
        <div>
          <h3 className='text-xl sm:text-2xl font-semibold text-slate-900 text-center mb-8 sm:mb-12 px-4'>
            Our Offerings in Defence Tech
          </h3>

          <div className='grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8'>
            <div className='bg-white/70 border border-slate-300 rounded-2xl p-6 sm:p-8 hover:bg-white/90 transition-colors hover:border-teal-500/50 shadow-lg'>
              <div className='flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 mb-4'>
                ...
                <div className='bg-teal-50 px-4 py-2 rounded-full border border-teal-200 inline-block w-fit'>
